...
SECRET_KEY = '7&_-j&2jpvvt@4b3*7*ax@!t5q1gbn^-(-bh(^1cewo@uzy8qe'
...
MIDDLEWARE_CLASSES = (
    ...
    # 'booktest.middleware.TestMiddleware',  # 注册
...
# 设置上传文件的保存目录
MEDIA_ROOT = os.path.join(BASE_DIR, 'static/media')  # static前不能加斜杠，不然结果就只有/static/media
