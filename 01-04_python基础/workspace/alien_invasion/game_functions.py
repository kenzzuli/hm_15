...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    #continue fire!!!!
    if ai_settings.fire and (ai_settings.loop_number==0):
        fire_bullet(ai_settings, screen, ship, bullets)
    ai_settings.loop_number+=1
    ai_settings.loop_number=ai_settings.loop_number%80
